...
function updateSteps(clickedStep) {
    ...
    let previousSiblings = Array.from(clickedStep.previousElementSibling ? clickedStep.previousElementSibling.previousElementSibling : null);
    previousSiblings.forEach(function(sibling) {
        sibling.classList.add('active');
    });

    let nextSiblings = Array.from(clickedStep.nextElementSibling ? clickedStep.nextElementSibling.nextElementSibling : null);
